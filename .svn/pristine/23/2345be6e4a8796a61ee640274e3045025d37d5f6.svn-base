var App = function () {
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            ...
            $('#logoimg').attr("src", "../Images/logo_" + color + ".png");
            $('#rev-hint1').attr("src", "../Images/sliders/revolution/hint1-" + color + ".png");
            $('#rev-hint2').attr("src", "../Images/sliders/revolution/hint2-" + color + ".png");
        }
